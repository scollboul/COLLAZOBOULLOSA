...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.editArtic = QtWidgets.QLineEdit(self.panelPro)
        self.editArtic.setGeometry(QtCore.QRect(140, 30, 398, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.editPrec = QtWidgets.QLineEdit(self.panelPro)
        self.editPrec.setGeometry(QtCore.QRect(630, 30, 111, 22))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
