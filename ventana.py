...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.gridFormsup.addItem(spacerItem6, 2, 6, 1, 1)
        ...
        self.gridFormsup.addItem(spacerItem7, 2, 1, 1, 1)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/backup/backup.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Salir/iconsalir.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
