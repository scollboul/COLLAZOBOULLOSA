...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.lblCodFac = QtWidgets.QLabel(self.panelFac)
        self.lblCodFac.setGeometry(QtCore.QRect(110, 30, 45, 32))
        self.lblCodFac.setMaximumSize(QtCore.QSize(45, 16777215))
        self.lblCodFac.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.lblCodFac.setMouseTracking(False)
        self.lblCodFac.setAutoFillBackground(False)
        self.lblCodFac.setStyleSheet("background-color: rgb(255, 253, 217);")
        self.lblCodFac.setText("")
        self.lblCodFac.setObjectName("lblCodFac")
        self.lblFactura = QtWidgets.QLabel(self.panelFac)
        self.lblFactura.setGeometry(QtCore.QRect(36, 40, 61, 20))
        self.lblFactura.setObjectName("lblFactura")
        self.lblFechaFactura = QtWidgets.QLabel(self.panelFac)
        self.lblFechaFactura.setGeometry(QtCore.QRect(190, 40, 81, 20))
        self.lblFechaFactura.setObjectName("lblFechaFactura")
        self.lblCliente = QtWidgets.QLabel(self.panelFac)
        self.lblCliente.setGeometry(QtCore.QRect(40, 100, 81, 20))
        self.lblCliente.setObjectName("lblCliente")
        self.EditTextCli = QtWidgets.QLineEdit(self.panelFac)
        self.EditTextCli.setGeometry(QtCore.QRect(100, 100, 113, 20))
        self.EditTextCli.setObjectName("EditTextCli")
        self.btnCalendario = QtWidgets.QPushButton(self.panelFac)
        self.btnCalendario.setGeometry(QtCore.QRect(310, 40, 41, 23))
        self.btnCalendario.setObjectName("btnCalendario")
        self.btnFacturar = QtWidgets.QPushButton(self.panelFac)
        self.btnFacturar.setGeometry(QtCore.QRect(360, 40, 75, 23))
        self.btnFacturar.setObjectName("btnFacturar")
        self.btnAnular = QtWidgets.QPushButton(self.panelFac)
        self.btnAnular.setGeometry(QtCore.QRect(450, 40, 75, 23))
        self.btnAnular.setObjectName("btnAnular")
        self.EditTextClApels = QtWidgets.QLineEdit(self.panelFac)
        self.EditTextClApels.setGeometry(QtCore.QRect(230, 100, 113, 20))
        self.EditTextClApels.setObjectName("EditTextClApels")
        self.btnBuscar = QtWidgets.QPushButton(self.panelFac)
        self.btnBuscar.setGeometry(QtCore.QRect(370, 90, 51, 41))
        self.btnBuscar.setObjectName("btnBuscar")
        self.btnRefresh = QtWidgets.QPushButton(self.panelFac)
        self.btnRefresh.setGeometry(QtCore.QRect(440, 90, 51, 41))
        self.btnRefresh.setObjectName("btnRefresh")
        self.btnOkey = QtWidgets.QPushButton(self.panelFac)
        self.btnOkey.setGeometry(QtCore.QRect(650, 90, 51, 41))
        self.btnOkey.setObjectName("btnOkey")
        self.btnCancelar = QtWidgets.QPushButton(self.panelFac)
        self.btnCancelar.setGeometry(QtCore.QRect(720, 90, 51, 41))
        self.btnCancelar.setObjectName("btnCancelar")
        self.TableFact = QtWidgets.QTableWidget(self.panelFac)
        self.TableFact.setGeometry(QtCore.QRect(40, 140, 211, 491))
        ...
        self.tableVenta = QtWidgets.QTableWidget(self.panelFac)
        self.tableVenta.setGeometry(QtCore.QRect(260, 140, 531, 491))
...
""))
        self.lblFactura.setText(_translate("venPrincipal", "NºFactura"))
        ...
        self.btnCalendario.setText(_translate("venPrincipal", "PushButton"))
        self.btnFacturar.setText(_translate("venPrincipal", "Facturar"))
        self.btnAnular.setText(_translate("venPrincipal", "Anular"))
        self.btnBuscar.setText(_translate("venPrincipal", "PushButton"))
        self.btnRefresh.setText(_translate("venPrincipal", "PushButton"))
        self.btnOkey.setText(_translate("venPrincipal", "PushButton"))
        self.btnCancelar.setText(_translate("venPrincipal", "PushButton"))
        ...
        item.setText(_translate("venPrincipal", "Fecha Factura"))
        item = self.tableVenta.horizontalHeaderItem(0)
        item.setText(_translate("venPrincipal", "Cod Venta"))
