...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.EditDNICli.setGeometry(QtCore.QRect(110, 100, 113, 16))
        ...
        self.EditApelCli.setGeometry(QtCore.QRect(230, 100, 113, 16))
        ...
        self.btnFacturar.setGeometry(QtCore.QRect(490, 40, 75, 21))
        ...
        self.tableWidget = QtWidgets.QTableWidget(self.panelFac)
        self.tableWidget.setGeometry(QtCore.QRect(300, 130, 581, 501))
    ...
    def retranslateUi(self, venPrincipal):
        ...
        item.setText(_translate("venPrincipal", "Articula"))
